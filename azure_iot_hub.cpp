...
//
// Note: To configure devices,
// see information on installing the az iot cli here: 
// https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-raspberry-pi-kit-c-lesson2-get-azure-tools-ubuntu
//
// to get your connection string use:
// az iot device show-connection-string --hub-name yourhubname --device devicename
// 
static const char* connection_string = "";

//
// To monitor messages sent to device "devicename" use az iot as follows:
//    iothub-explorer connectionstring monitor-events "devicename"
//
